...
Category = {
    ...
    # Overlap
    "overlap": [
        "alma", "dema", "ema", "ema_align", "fwma", "hilo", "hl2", "hlc3", "hma", "ichimoku",
        "jma", "kama", "linreg", "linreg_channel", "mcgd", "midpoint", "midprice", "mmar",
    ...
    "trend": [
        ...
        "short_run", "tsignals", "ttm_trend", "vhf", "vortex", "xsignals", "zigzag"
    ],
    # Volatility
    "volatility": [
