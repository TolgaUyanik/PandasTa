...
class AnalysisIndicators(BasePandasObject):
    ...
    def cdl_pattern(self, name="all", scalar=None, offset=None, **kwargs):
        open_ = self._get_column(kwargs.pop("open", "open"))
        high = self._get_column(kwargs.pop("high", "high"))
        low = self._get_column(kwargs.pop("low", "low"))
        close = self._get_column(kwargs.pop("close", "close"))
        result = cdl_pattern(open_=open_, high=high, low=low, close=close, name=name, scalar=scalar, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)

    def cdl_z(self, length=None, full=None, offset=None, **kwargs):
        open_ = self._get_column(kwargs.pop("open", "open"))
        high = self._get_column(kwargs.pop("high", "high"))
        low = self._get_column(kwargs.pop("low", "low"))
        close = self._get_column(kwargs.pop("close", "close"))
        result = cdl_z(open_=open_, high=high, low=low, close=close, length=length, full=full, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)
    ...
    def dm(self, length=None, mamode=None, offset=None, **kwargs):
        high = self._get_column(kwargs.pop("high", "high"))
        low = self._get_column(kwargs.pop("low", "low"))
        result = dm(high=high, low=low, length=length, mamode=mamode, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)
    ...
    def lrsi(self, length=None, gamma=None, offset=None, **kwargs):
        close = self._get_column(kwargs.pop("close", "close"))
        result = lrsi(close=close, length=length, gamma=gamma, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)
    ...
    def pressure_pulse(self, balance_length=None, min_gain=None, max_gain=None,
        ...
        low = self._get_column(kwargs.pop("low", "low"))
        close = self._get_column(kwargs.pop("close", "close"))
        result = pressure_pulse(
            open_=open_, high=high, low=low, close=close,
            balance_length=balance_length, min_gain=min_gain, max_gain=max_gain,
    ...
    def stc(self, tclength=None, fast=None, slow=None, factor=None, offset=None, **kwargs):
        close = self._get_column(kwargs.pop("close", "close"))
        result = stc(close=close, tclength=tclength, fast=fast, slow=slow, factor=factor, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)
    ...
    def trixh(self, length=None, signal=None, scalar=None, drift=None, offset=None, **kwargs):
        close = self._get_column(kwargs.pop("close", "close"))
        result = trixh(close=close, length=length, signal=signal, scalar=scalar, drift=drift, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)
    ...
    def ht(self, offset=None, **kwargs):
        close = self._get_column(kwargs.pop("close", "close"))
        result = ht(close=close, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)


    def frama(self, length=None, offset=None, **kwargs):
        high = self._get_column(kwargs.pop("high", "high"))
        low = self._get_column(kwargs.pop("low", "low"))
        close = self._get_column(kwargs.pop("close", "close"))
        result = frama(high=high, low=low, close=close, length=length, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)



    def vstop(self, length=None, factor=None, offset=None, **kwargs):
        high = self._get_column(kwargs.pop("high", "high"))
        low = self._get_column(kwargs.pop("low", "low"))
        close = self._get_column(kwargs.pop("close", "close"))
        result = vstop(high=high, low=low, close=close, length=length, factor=factor, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)

    def vstop2(self, length=None, factor=None, offset=None, **kwargs):
        high = self._get_column(kwargs.pop("high", "high"))
        low = self._get_column(kwargs.pop("low", "low"))
        close = self._get_column(kwargs.pop("close", "close"))
        result = vstop2(high=high, low=low, close=close, length=length, factor=factor, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)

    def stc_tv(self, fast=None, slow=None, cycle=None, d1=None, d2=None, offset=None, **kwargs):
        close = self._get_column(kwargs.pop("close", "close"))
        result = stc_tv(close=close, fast=fast, slow=slow, cycle=cycle, d1=d1, d2=d2, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)
    ...
    def thermo(self, long=None, short= None, length=None, mamode=None, drift=None, offset=None, **kwargs):
        ...
        low = self._get_column(kwargs.pop("low", "low"))
        close = self._get_column(kwargs.pop("close", "close"))
        result = thermo(high=high, low=low, close=close, long=long, short=short, length=length, mamode=mamode, drift=drift, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)
    ...
    def kvo(self, fast=None, slow=None, signal=None, mamode=None, offset=None, **kwargs):
        high = self._get_column(kwargs.pop("high", "high"))
        low = self._get_column(kwargs.pop("low", "low"))
        close = self._get_column(kwargs.pop("close", "close"))
        volume = self._get_column(kwargs.pop("volume", "volume"))
        result = kvo(high=high, low=low, close=close, volume=volume, fast=fast, slow=slow, signal=signal, mamode=mamode, offset=offset, **kwargs)
        return self._post_process(result, **kwargs)
